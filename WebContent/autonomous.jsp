		...
		<form id="autonomousForm" action="autonomous.jsp" method="POST">
			<div id="Team1" class="team">
				...
				<div id="Team1AutoScore">
					...
					<div id="Team1ScoreFail">
						...
						<input id="chkTeam1ScoreFail" type="checkbox" name="chkTeam1ScoreFail" value="N">
						<label for="chkTeam1ScoreFail">Failed to Score</label>
					</div>
				</div>
			</div>
			<div id="Team2" class="team">
				...
				<div id="Team2AutoScore">
					<div id="Team2Reached">
						<input type="checkbox" name="chkTeam2Reached"
							id="chkTeam2Reached" value="Y"> <label
							for="chkTeam2Reached">Reached Defense</label>
					</div>
					<div id="Team2Crossed">
						<input type="checkbox" name="chkTeam2Crossed"
							id="chkTeam2Crossed" value="Y"> <label
					...
					<div id="Team2ScoreFail">
						<!-- Note: Checked value "N" actually means that by default, the team succeeded. It's illogical in programming, but easier for the scorer. -->
						<input id="chkTeam2ScoreFail" type="checkbox" name="chkTeam2ScoreFail" value="N">
						<label for="chkTeam2ScoreFail">Failed to Score</label>
					</div>
				</div>
			</div>
			<div id="Team3" class="team">
				...
				<div id="Team3AutoScore">
					<div id="Team3Reached">
						<input type="checkbox" name="chkTeam3Reached"
							id="chkTeam3Reached" value="Y"> <label
							for="chkTeam3Reached">Reached Defense</label>
					</div>
					<div id="Team3Crossed">
						<input type="checkbox" name="chkTeam3Crossed"
							id="chkTeam3Crossed" value="Y"> <label
					...
					<div id="Team3ScoreFail">
						<!-- Note: Checked value "N" actually means that by default, the team succeeded. It's illogical in programming, but easier for the scorer. -->
						<input id="chkTeam3ScoreFail" type="checkbox" name="chkTeam3ScoreFail" value="N">
						<label for="chkTeam3ScoreFail">Failed to Score</label>
					</div>
				</div>
			</div>
