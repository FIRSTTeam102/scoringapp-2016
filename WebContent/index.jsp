...
<body class="no-js">
    <div id="page">
        <div class="header">
			<img src="http://team102.org/2015/favicon.ico" style="float: right; padding: 3px 15px 0px 10px;"/>
			...
			<div style="padding-top: 10px;padding-bottom: 10px;"><input type="submit" name="btnUpcoming" value="Team 102 Upcoming Matches" /></div>
			<div style="padding-top: 10px;padding-bottom: 10px;"><input type="submit" name="btnAlliance" value="Team 102 Alliance Selection" /></div>
			<div style="padding-top: 10px;padding-bottom: 10px;"><input type="submit" name="btnLighterApp" value="Lighter Color Stuffz" /></div>
		</div>
	</form>
        </div>
    </div>
